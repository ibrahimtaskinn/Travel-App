package com.example.graduationproject.ui.home.tablayout.flights
...
import com.example.graduationproject.databinding.FragmentFligthsBinding
...
class FlightsFragment : Fragment() {
    ...
    private lateinit var binding: FragmentFligthsBinding

    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View {
        binding = FragmentFligthsBinding.inflate(layoutInflater)
        return binding.root
    }
